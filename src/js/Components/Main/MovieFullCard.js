        ...
        <div id="content"
            ...
            <div className="row">
                <div className="col-sm-3">
                    <img className="img-fluid" src={movie.moviePosterLink}
                         alt="Movie poster"/>
                ...
                <div className="col-sm-6">
                    <ul className="movie-info pl-0">
                        <li className="d-flex">
                            ...
                            <p className="col-9">{movie.movieDetailInfoYear}</p>
                        </li>
                        <li className="d-flex">
                            <p className="col-3">страна</p>
                            <p className="col-9">{movie.movieDetailInfoCountry}</p>
                        </li>
                        <li className="d-flex">
                            <p className="col-3">режиссер</p>
                            <p className="col-9">{movie.movieDetailInfoDirector}</p>
                        </li>
                    </ul>
                    <div className="movie-description mt-5">
                        <p className="font-weight-bold">IMDb: {movie.movieImdbRate}</p>
                ...
                <div className="col-sm-3">
                    ...
                    <ul className="list-unstyled">
                        {movie.movieActors.map((actor) => <li>{actor}</li>)}
                    </ul>
                </div>
            </div>
        </div>)
